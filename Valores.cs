...
public static List<string> stats = new List<string> {$"Força (For)","Velocidade (Vel)","Mental (Men)","Observação (Obs)"}; public static List<int> pontostats = [1, 1, 1, 1]; 
...
public static List<string> listapassagens = new List<string> {$""}; public static Random dadopass = new Random(); public static int númeropassagem = dado.Next(1, 6); public static int passagensvalor; public static int javali = 1; public static int canção = 1; public static bool tontura = true;}
